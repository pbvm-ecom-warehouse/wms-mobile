...
export async function listGoodsIssues(forceRefresh = false): Promise<GoodsIssue[]> {
  const response = await cachedGet<ApiListResponse<GoodsIssue> | GoodsIssue[]>('/goods-issues', undefined, { forceRefresh });
